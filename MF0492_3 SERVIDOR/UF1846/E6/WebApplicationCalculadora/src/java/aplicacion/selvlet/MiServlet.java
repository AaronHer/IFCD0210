...
//out.println("<h1>Servlet MiServlet at " + request.getContextPath() + "</h1>");
            ...
            String dierccion = request.getParameter("Dirección");
            String dia = request.getParameter("Dias");
            String valor = request.getParameter("Valor");
            String btnCalcular = request.getParameter("botonCalcular");
            
             if(btnCalcular != null){
                int sueldoDia = Integer.parseInt(valor)*8;
                int resultado = Integer.parseInt(dia) * sueldoDia; 
                    out.println("Nombre: " + nom + "<br>" );
                    out.println("Dirección: " + dierccion + "<br>" );
                    out.println("Sueldo al mes: " + resultado + "€" );
            }
